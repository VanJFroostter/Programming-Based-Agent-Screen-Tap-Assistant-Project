...
CMD3_EXEC = (
    ...
    '五选一（或任务定义的动作）唯一取值；【禁止】只打印五个决策选项各自的说明文字而不输出最终决策；'
    ...
    '（如 黄金决策结果.txt、决策结果.txt 等）】，然后用系统默认程序打开该文件'
...
def build_gui():
    ...
    ttk.Label(root, text="您要完成什么任务？", font=("", 14, "bold")).grid(
