...
![Agent Workflow Diagram](./outcomeeg.png)
...
2. Make sure the web search option is checked  ![Agent Workflow Diagram](./internetbuttoneg.png)
...
![Agent Workflow Diagram](./outcome.png)
...
1. 将py文件放入一个空文件夹
2. 确保已经勾选联网搜索按钮   ![Agent Workflow Diagram](./internetbutton.png)
